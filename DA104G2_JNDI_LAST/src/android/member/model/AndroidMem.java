...
public class AndroidMem implements Serializable {
	...
	public AndroidMem(String mem_no, String mem_name, String mem_id, String mem_psw, Integer mem_general_gen,
			Date mem_general_bd, Integer mem_tel, String mem_email, String mem_add, Integer mem_per,
			Integer mem_type,  String mem_store_owner, String mem_store_taxid) {
		super();
		this.mem_no = mem_no;
