...
<%
	GroupVO groupupdateVO = (GroupVO) request.getAttribute("groupupdateVO");
%>
<!DOCTYPE html>
<html lang="zh-Hant">
...
<link rel=stylesheet type="text/css" href="<%=request.getContextPath()%>/css/add_group.css">
...
body{
	background-image: url(https://images.unsplash.com/photo-1563566019199-854467dad6ff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80);
...
<body>
			...
			<form METHOD="post"
				...
				<div class="row">
					...
					<div class="form-group col-8">
							...
							<option value="erro">--請選擇潛點--
								<c:forEach var="diveVO" items="${diveSvc.getAll()}">
									<option value="${diveVO.dive_no}"
										<c:if test="${groupupdateVO.getDive_no()==(diveVO.getDive_no())}">selected='selected'</c:if>>${diveVO.dive_name}
								</c:forEach>
						</select>
						<!-- 揪團名稱 -->
						<div class="form-group" id="groupname">
							<label for="inputAddress">揪團名稱*</label> <input type="text"
								...
								value="${groupupdateVO.getGroup_name()}"
								required>
						</div>
					</div>
					...
					<div class="form-group col-4 upload">
						<div class="photo">
							<img
								src="<%=request.getContextPath()%>/ShowPic_V1?group_no=<%=groupupdateVO.getGroup_no()%>"
				...
				<div class="form-group">
					<label for="inputAddress">連絡電話</label> <input name="group_tel"
						...
						value="${groupupdateVO.group_tel}"
						required>
				</div>
				<!-- 活動日期 -->
				<label for="from">活動日期</label>
				<div class="date">
					<input type="text" name="group_begin_time" class="start-end"
						id="f_date1" value="${group_begin_time}"> <label for="to">－</label> <input type="text"
						name="group_end_time" class="start-end" id="f_date2" value="${group_end_time}">
				</div>

				<!-- 報名截止日期 -->
				<label for="from">報名截止日期</label>
				<div class="date">
					<input type="text" name="group_tour_stop_time" class="start-end"
						id="f_date3" value="${group_tour_stop_time}">
				</div>
				...
				<div class="row">
					<div class="col-sm-12 col-md-8 col-md-offset-2">
						...
						<div class="city-selector-set">
							...
							<input name="group_mp3" type="text" class="form-control"
				...
				<!-- 設定上限人數 -->
				<label for="customRange1" id="maxpeople">上限人數：${groupupdateVO.getGroup_max_num()}</label>
				<input name="group_max_num" type="range" class="custom-range"
					id="customRange1" value="${groupupdateVO.getGroup_max_num()}" min="2"
					max="20" oninput="change()" onchange="change()">
				...
				<div class="form-group">
					...
					<textarea name="group_des" cols="50" rows="6" class="GROUP_DES">${groupupdateVO.group_des }</textarea>
				</div>


				<!-- 修改 -->
				<div class="submit">
					<input type="hidden" name="group_no" value="${groupupdateVO.group_no}">
	...
	<footer>
		<img src="<%=request.getContextPath()%>/images/tw_blk.png"
		...
		<ul class="nav justify-content-center" id="icon">
			<li class="nav-item"><svg id="fb" width="25px" height="25px" viewBox="0 0 96.124 96.123">
                    <path
