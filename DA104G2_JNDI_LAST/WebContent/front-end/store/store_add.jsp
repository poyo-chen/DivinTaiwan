										...
										<div class="col-12">
											<div class="login-form">
												...
												<form method="post" action="<%=request.getContextPath()%>/tour/tour.do" enctype="multipart/form-data">
													...
													<div class="form-group">
														<label>價格</label> 
														<input id="tourPrice" type="text" name="tour_price" class="form-control"
														value="${tourVO.tour_price == null ? '' : tourVO.tour_price}">
														<span class="errorMsgs">${errorMsgs['tourPriceError']}</span>
													</div>
													<div class="form-group">
														<label>潛水支數</label> 
														<input id="tourDives" type="text" name="tour_dives" class="form-control"
													...
													<div class="form-group">
														<label>最多參加人數</label> 
														<input id="tourMaxNum" type="text" name="tour_max_num" class="form-control"
													...
													<div class="form-group">
														<label>房間容納人數</label> 
														<input id="roomPpl" type="text" name="room_ppl" class="form-control"
...
<% 
	...
	//若無輸入回傳也不作填寫
	try{
		tour_bgn_date = tourVO.getTour_bgn_date();
	} catch(Exception e){}
	
	try{
		tour_end_date = tourVO.getTour_end_date();
	} catch(Exception e){}
	
	try{
		tour_stop_date = tourVO.getTour_stop_date();
	} catch(Exception e){}
