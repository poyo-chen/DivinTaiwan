...
<%
	...
	List<EquipmentVO> list = equipSvc.getStatus(1);
		...
		<div class="row">
			...
			<div class="col-2">
				<FORM method="post"
					...
					<div class="keyword">
						<input type="text" placeholder="請輸入裝備名稱"
							style="border-radius: 10px" name="keyword" value="" class="form-control" id="equipShopInput"> <input
							type="hidden" name="action" value="get_keyword">
