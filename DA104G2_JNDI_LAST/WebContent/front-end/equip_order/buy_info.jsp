...
<body>
	...
	<!-- 付款表單 -->
	<FORM method="post" action="<%=request.getContextPath()%>/order/equip_order.do">
	...
	<table class="table">
		...
		<tr>
			<th scope="col"></th>
			<th scope="col" style="padding-left:150px">付款資訊</th>
		</tr>
		</thead>
		<tbody>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="cus_name" size="20" value="<%=(equiporderVO == null) ? "" : equiporderVO.getCus_name()%>"></td>    
		</tr>
		<tr>
			<th scope="row">收件人手機</th>
			<td><input type="text" name="cus_tel" size="20" value="<%=(equiporderVO == null || equiporderVO.getCus_tel() == null) ? "" : equiporderVO.getCus_tel()%>"></td>    
		</tr>
		<tr>
			...
			<td>
				...
				<p>
					<input type="text" name="cus_add" id="address" class="form-control" placeholder="Address">
				</p>
				</div>
			</td>    
		</tr>
		<tr>
			<th scope="row">備註</th>
			<td><textarea cols="45" rows="5" name="equip_note" value=""></textarea></td>
		</tr>
		<tr>
			<th scope="row"></th>
			<td style="padding-left:400px"><button type="submit" class="btn btn-warning">確認付款</button></td>    
		</tr>
		</tbody>
	</table>
	</div>
	...
	<input type="hidden" name="equip_order_price" value="<%= amount %>">
			...
			<div class="row">
					...
					<div class="creditcard">
						<div class="front">
                            ...
                            <g id="Front">
                              ...
                              <text
									transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">
                                card number
                              </text>
                              <g>
                                <text
				...
				<div class="form-container">
					<div class="field-container">
						<label for="name">Name</label> <input class="c" name="c_name" id="name" maxlength="20"
							type="text" />
					</div>
					<div class="field-container">
						<label for="cardnumber">Card Number</label> <input class="c" name="c_number" id="cardnumber"
					...
					<div class="field-container">
						<label for="expirationdate">Expiration (mm/yy)</label> <input
							class="c" id="expirationdate" type="text" pattern="[0-9]*"
							inputmode="numeric" />
					</div>
					<div class="field-container">
						<label for="securitycode">Security Code</label> <input
							class="c" id="securitycode" type="text" pattern="[0-9]*"
							inputmode="numeric" />
					</div>
				</div>
			</div>
