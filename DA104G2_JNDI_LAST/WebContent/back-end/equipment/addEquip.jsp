		...
		<div class="container-fluid">
			<table class="table">
				<thead class="thead-dark">
					<tr>
						<th scope="col"></th>
						<th scope="col" style="padding-right: 140px">資料新增</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td class="right"><input type="text" name="equip_name" size="45"
							value="<%=(equipmentVO == null) ? "裝備XX" : equipmentVO.getEquip_name()%>"></td>
					</tr>
					<tr>
						<th scope="row" class="left">裝備描述</th>
						<td class="right"><textarea cols="45" rows="5" name="equip_des"><%=(equipmentVO == null) ? "裝備描述XX" : equipmentVO.getEquip_des()%></textarea></td>
					</tr>
					<tr>
						<th scope="row" class="left">裝備預覽圖1</th>
						<td class="right"><div id="showpic1"></div>
							<input type="file" name="equip_img1" id="equip_img1"></td>
					</tr>
					<tr>
						<th scope="row" class="left">裝備預覽圖2</th>
						<td class="right"><div id="showpic2"></div>
							<input type="file" name="equip_img2" id="equip_img2"></td>
					</tr>
					<tr>
						<th scope="row" class="left">裝備預覽圖3</th>
						<td class="right"><div id="showpic3"></div>
							<input type="file" name="equip_img3" id="equip_img3"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="right"><input type="text" name="equip_price" size="20"
							value="<%=(equipmentVO == null) ? "100" : equipmentVO.getEquip_price()%>" /></td>
					</tr>
					<tr>
						<th scope="row"></th>
						<td style="padding-left: 380px"><button type="submit"
								class="btn btn-success">送出新增</button></td>
					</tr>
				</tbody>
			</table>
		</div>
