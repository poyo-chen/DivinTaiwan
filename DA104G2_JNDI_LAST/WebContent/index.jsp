...
<body>
		...
		<div class="col-12 h-100">
			<div class="row align-items-end h-50">
				...
				<div class="col-6 caption">
					<p>Under every rock, around every</p>
					<p>reef, a new discovery awaits.</p>
					<a class="btn btn-primary btn-lg diveIn"
						href="<%=request.getContextPath()%>/front-end/dive/GoogleMapTest2.jsp">潛點</a>
				</div>
				<div class="col-3">
					<c:if test="${memVO!=null}">
						<button class="chatbtn btn" onclick="showChat()">
							<img width="50px" height="50px" src="<%=request.getContextPath()%>/images/chat.png">
						</button>
	...
	<!-- 熱門揪團cards -->
	<div class="container-fluid" id="div_grp">
		...
		<div class="row justify-content-center align-items-center h-75"
			...
			<c:forEach var="groupVO" items="${list2}">
				<form action="<%=request.getContextPath()%>/group/group.do">
					<div class="card_col col-12 col-lg-3 col-md-6">
						<div class="card">
							<img class="card-img-top card-img"
								src="<%=request.getContextPath()%>/Group_photo_Show?group_no=${groupVO.group_no}">
							<div class="card-body">
								<div id="area1">
									<span class="dest card-title">${groupVO.group_name}</span>
								</div>
								<div id="date1">
									<span class="time card-text">${groupVO.group_des}</span>
								</div>
								<div id="addGrp1">
									<button type="submit" id="btn_addGrp1" class="btn">加入揪團</button>
								</div>
							</div>
						</div>
					</div>
